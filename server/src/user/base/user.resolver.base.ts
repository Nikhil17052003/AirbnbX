...
export class UserResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [SetupWishlist], { name: "setupWishlists" })
  @nestAccessControl.UseRoles({
  ...
  async findSetupWishlists(
    ...
    const results = await this.service.findSetupWishlists(parent.id, args);
  ...
  async getListings(@graphql.Parent() parent: User): Promise<Listing | null> {
