...
export class ListingResolverBase {
  ...
  async createListing(
    ...
    return await this.service.createListing({
      ...
      data: {
        ...
        setupWishlist: args.data.setupWishlist
          ? {
              connect: args.data.setupWishlist,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => SetupWishlist, {
    nullable: true,
    name: "setupWishlist",
  })
  @nestAccessControl.UseRoles({
  ...
  async getSetupWishlist(
    @graphql.Parent() parent: Listing
  ): Promise<SetupWishlist | null> {
    const result = await this.service.getSetupWishlist(parent.id);
